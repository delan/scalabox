...
function update_preview() {
	var hf = $('#horizontal_factor').val(),
		...
		fs = $('#font_size').val(),
		fw = $('#fallback_viewport_width').val(), // fallback width (px)
		fh = fw * vf / hf, // fallback height (px)
	...
	'/* end scalabox */'
		...
		// A quick 'expression interpolation' hack here seriously cuts
		// down on code size and ugly' + entries / exits * from +
		// 'strings and improves clarity even though people think
		// eval() == evil().
	}
